...
export function ProjectFeatureCard({
  ...
  return (
    ...
    >
      <div className="relative bg-white rounded-[30px] border border-yellow-400 p-6 md:p-8 lg:p-10">
        {/* Большой номер слева, частично перекрывающий рамку */}
        <div className="absolute -left-4 md:-left-6 lg:-left-8 top-0 bottom-0 flex items-center">
          <span className="project-feature-number">{number}</span>
        </div>

        {/* Контент */}
        <div className="ml-8 md:ml-12 lg:ml-16">
          <h3 className="project-feature-title mb-3 md:mb-4">
            {title}
          </h3>
