...
export function ProjectContentSection({
  ...
  return (
    ...
    >
      <div className='project-content-border relative border-t-0 border-b-[3px] border-b-[#5e6061] rounded-[30px] overflow-hidden bg-white p-8 md:p-10 lg:p-12 xl:p-16'>
